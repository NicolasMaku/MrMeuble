...
create table centre (
    id_centre int primary key default nextval('seq_centre'),
    nom varchar(50),
    categorie int -- 1 direct , 0 indirect
);

create table unite_oeuvre (
    id_unite_oeuvre int primary key nextval('seq_unite_oeuvre'),
    nom varchar(20)
);

create table rubrique (
    id_rubrique int PRIMARY KEY DEFAULT nextval('seq_rubrique'),
    libelle varchar(20),
...
create table imputation (
    id_imputation int primary key default nextval('seq_imputation'),
