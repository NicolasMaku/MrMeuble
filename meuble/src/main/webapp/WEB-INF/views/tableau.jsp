    ...
    <div class="table-container relative max-h-[75dvh] overflow-y-auto">
        <table class="table table-xs" id="table-3">
            ...
            <tr>
                ...
                <th class="number text-right text-black"><%=cout.getCoutRevient()%></th>
            </tr>
            </tfoot>
        </table>
    </div>
    ...
    <div class="table-container relative max-h-[75dvh] overflow-y-auto">
        ...
        <div class="flex items-center justify-center gap-2">
            <div class="flex items-center gap-4 py-2 px-4 w-3/6">
                <p>Seuil:</p>
                <svg xmlns="http://www.w3.org/2000/svg" width="85.256px" height="38.896px" viewBox="0 -1381 4710.4 2149" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" style="">
                    <defs>
                        ...
                        <path id="MJX-5-TEX-N-2212" d="M84 237T84 250T98 270H679Q694 262 694 250T679 230H98Q84 237 84 250Z"></path>
                        <path id="MJX-5-TEX-I-1D449"
                    ...
                    <g stroke="#000000" fill="#000000" stroke-width="0" transform="scale(1,-1)">
                        <g data-mml-node="math">
                            <g data-mml-node="mfrac">
                                <g data-mml-node="mrow" transform="translate(1600.7,676)">
                                    <g data-mml-node="mi">
                                ...
                                <g data-mml-node="mrow" transform="translate(220,-686)">
                                    ...
                                    <g data-mml-node="mi" transform="translate(760,0)">
                                        <use data-c="1D445" xlink:href="#MJX-5-TEX-I-1D445"></use>
                                    </g>
                                    <g data-mml-node="mo" transform="translate(1741.2,0)">
                                        <use data-c="2212" xlink:href="#MJX-5-TEX-N-2212"></use>
                                    </g>
                                    <g data-mml-node="mi" transform="translate(2741.4,0)">
                                        <use data-c="1D436" xlink:href="#MJX-5-TEX-I-1D436"></use>
                                    </g>
                                    <g data-mml-node="mi" transform="translate(3501.4,0)">
                                        <use data-c="1D449" xlink:href="#MJX-5-TEX-I-1D449"></use>
                                    </g>
                                </g>
                                <rect width="4470.4" height="60" x="120" y="220"></rect>
                            </g>
                        </g>
                    </g>
                </svg>
