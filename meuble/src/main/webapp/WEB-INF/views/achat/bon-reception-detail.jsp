...
<%
    List<BonReceptionFille> bonReceptionsFille= (List<BonReceptionFille>)request.getAttribute("brFille");
%>
...
<div class="overflow-x-auto bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 text-black">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-black text-center"><%=bonReceptionsFille.get(i).getIdBr()%></td>
            <td class="text-black text-center"><%=bonReceptionsFille.get(i).getIdMarchandise()%></td>
